...
def simulate(db, datageni):
	purchase_evcon = event_consumer.EventConsumer(db, consumer_purchase_event.handle_purchase_event, 'purchase_event', 'purchase_event')
	purchase_consumer = Thread(target=purchase_evcon.consume, args=( ))
	purchase_consumer.start()

	gameplay_evcon = event_consumer.EventConsumer(db, consumer_gameplay_event.handle_gameplay_event, 'gameplay_event', 'gameplay_event')
